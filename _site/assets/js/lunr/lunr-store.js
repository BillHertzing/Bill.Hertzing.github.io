var store = [{
        ...
        "excerpt":"TL DR If you would like to have access to my posts and pictures about family and friends, direct message me via text message, e-mail or a phone call. I’ll add you to the list of people who have access. In the future, I hope to have a simple login...","categories": ["personal"],
        "tags": ["Introduction","Personal"],
        "url": "/personal/Welcome-to-the-Personal-section-of-my-site/",
        "teaser": null
      },{
        "title": "Why I Wanted A Blog",
        "excerpt":"TL DR As a place to share knowledge, tips and how-tos, mostly regarding development, operations and monitoring of computer systems. As a place to publish the reasoning that underlie my personal stance on sometimes controversial political issues. As a place to share pictures and stories about myself and my family...","categories": ["political"],
        "tags": [],
        ...
        "excerpt":"Introduction I didn’t think that the very first post I’d make under this personal section would be in memory of Molly. She went from healthy to deathly in just three weeks, between the birthday of this site and before the release of V0.03. So here I am writing the first...","categories": ["personal"],
        "tags": ["Molly","Personal"],
